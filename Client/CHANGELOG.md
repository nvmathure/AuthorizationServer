...
- Create Angular project with ng: `ng new authorizationserver.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`authorizationserver.client.esproj`).
